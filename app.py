...
.mr{ right: -5px; top: 310px; text-align: left; }
...
.b2{ left: 40%; top: 420px; transform: translateX(-50%); }
...
def big_hearts_overlay(message=None):
    ...
    # IMPORTANT: this must run ALWAYS
    st.markdown(
        f"""
        <style>
        ...
        #hearts-overlay {{
          position: fixed;
          inset: 0;
          z-index: 1000001; /* behind white + big heart */
          pointer-events: none;
          overflow: hidden;
